...
<body ng-app="tagstered" ng-controller="LoginController" scroll="loadMore(recentTags.next_min_id)">
	...
	<script
		src="${pageContext.request.contextPath}/static/controller/login-controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/static/service/login-service.js"></script>
	<script
