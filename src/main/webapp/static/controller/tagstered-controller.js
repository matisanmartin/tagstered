		...
		.controller(
				...
				[
						...
						function($scope, $location, $log, $routeParams,
								UserService, InstagramTagService,
								InstagramAuthService, InstagramUserService) {
							...
							if ($scope.accessToken) {
								InstagramAuthService
										.getUserByAccessToken(
													...
													UserService
															.createOrUpdateUser(
																	...
																	function(
																		...
																		InstagramUserService.getUserInfo($scope.accessToken, function(response) {
																			$scope.currentIgUser = response.data;
																		}, function(response) {
												...
												function(data) {
													console
															.log("getUserByAccessToken {} error");
							...
							$scope.showTagRecentMedia = function(tagName) {
								...
								InstagramTagService.getRecentTagMedia(tagName,
										$scope.maxTagId, $scope.accessToken,
										function(response) {
